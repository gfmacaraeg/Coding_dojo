...
class Secrets(models.Model):
	...
	user = models.ForeignKey(User,related_name = 'secrets',on_delete=models.CASCADE)
	created_at = models.DateTimeField(auto_now_add=True)
	updated_at = models.DateTimeField(auto_now=True)


class Likes(models.Model):
	user = models.ForeignKey(User,related_name = 'userliked',on_delete=models.CASCADE)
	secret = models.ForeignKey(Secrets,related_name = 'secretsliked',on_delete=models.CASCADE)
	created_at = models.DateTimeField(auto_now_add=True)
	updated_at = models.DateTimeField(auto_now=True)
